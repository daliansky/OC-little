...
- 对于 OpenCore 而言，应当尽量避免更名操作，操作系统补丁本意是用以调试 ACPI，当调试完成应根据具体问题进行补丁的制作，在正常使用后应当删除操作系统补丁。其中某些机器由于用到了其它变量(如 OSID)，而且与操作系统补丁产生了冲突，因此需要首先将其进行更名以避免冲突的出现，但这些冲突的变量与操作系统补丁本质上没有任何关系，在调试完成后正常使用的情况下均应删除。
